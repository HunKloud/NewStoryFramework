modded class OptionsMenuSounds: ScriptedWidgetEventHandler
{
	...
	protected void AddNewStoryGroupOptionBody(NewStoryGroupOptionBodyBase body)
	{
		...
		body.Init( m_Root.FindAnyWidget("sound_settings_root"), m_DetailsRoot, this );
